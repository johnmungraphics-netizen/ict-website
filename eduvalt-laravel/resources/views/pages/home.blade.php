        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-8 text-center">
                <div class="section__title">
                    ...
                    <h2 class="title tg-svg">Driving <span class="position-relative"><span class="svg-icon" id="svg-skills" data-svg-icon="{{ asset('images/theme/icons/title_shape.svg') }}"></span>Digital</span> Transformation Across Africa</h2>
                </div>
            </div>
        </div>
