...
<head>
    ...
    <title>@yield('title', 'Eduvalt - Online Education')</title>
    
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('uploads/2023/06/favicon.png') }}" sizes="32x32" />
    <link rel="apple-touch-icon" href="{{ asset('uploads/2023/06/favicon.png') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('css/theme/fontawesome-all.min4d80.css') }}">
    <link rel="stylesheet" href="{{ asset('css/theme/flaticon-eduvalt4d80.css') }}">
    <link rel="stylesheet" href="{{ asset('css/theme/default-icons4d80.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/theme/tg-cursor4d80.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/plugins/flaticon4d80.css') }}">
...
<body class="wp-singular page-template theme-eduvalt no-sidebar">
    ...
    <script src="{{ asset('js/theme/tg-cursor.min4d80.js') }}"></script>
    <script src="{{ asset('js/theme/vivus.min4d80.js') }}"></script>
