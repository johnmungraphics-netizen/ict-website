...
<body class="wp-singular page-template theme-eduvalt no-sidebar">
    ...
    <!-- <script src="<?php echo e(asset('js/theme/tg-cursor.min4d80.js')); ?>"></script> REMOVED: Broken library causing errors -->
    <!-- <script src="<?php echo e(asset('js/theme/vivus.min4d80.js')); ?>"></script> REMOVED: Causing 15+ SVG errors -->
...
<?php /**PATH C:\ICT11\ICT1\ICT WEBSITE\eduvalt-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>