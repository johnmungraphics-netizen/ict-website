                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-8">
                        <div class="slider__content">
                            ...
                            <h2 class="title tg-svg" data-animation-in="slideInLeft" data-delay-in=".3" data-duration-in="0.8">Expert ICT Solutions <span class="position-relative"><span class="svg-icon" id="slider-0" data-svg-icon="<?php echo e(asset('images/theme/icons/title_shape.svg')); ?>"></span>Across</span> East Africa</h2>
                            ...
                            <div class="tg-button-wrap" data-animation-in="slideInLeft" data-delay-in=".5" data-duration-in="0.8">
                                <a href="#services" class="btn tg-svg"><span class="text">Our Services</span> <span class="svg-icon" id="slider-btn01-0" data-svg-icon="<?php echo e(asset('images/theme/icons/btn-arrow.svg')); ?>"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <img decoding="async" src="<?php echo e(asset('uploads/2023/07/categories_shape02.png')); ?>" alt="shape" width="108" class="top-shape" data-animation-in="slideInDown" data-delay-in=".6" data-duration-in="0.8" loading="lazy">
            <img decoding="async" src="<?php echo e(asset('uploads/2023/07/slider_shape.png')); ?>" alt="shape" class="bottom-shape" data-animation-in="slideInLeft" data-delay-in=".6" data-duration-in="0.8" loading="lazy">
        </div>
        <!-- Slide 2 -->
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-8">
                        <div class="slider__content">
                            ...
                            <h2 class="title tg-svg" data-animation-in="slideInLeft" data-delay-in=".3" data-duration-in="0.8">Innovative IT Solutions <span class="position-relative"><span class="svg-icon" id="slider-1" data-svg-icon="<?php echo e(asset('images/theme/icons/title_shape.svg')); ?>"></span>For Your</span> Organization</h2>
                            <ul class="list-wrap" data-animation-in="slideInLeft" data-delay-in=".4" data-duration-in="0.8">
                            ...
                            <div class="tg-button-wrap" data-animation-in="slideInLeft" data-delay-in=".5" data-duration-in="0.8">
                                <a href="#services" class="btn tg-svg"><span class="text">Our Services</span> <span class="svg-icon" id="slider-btn01-1" data-svg-icon="<?php echo e(asset('images/theme/icons/btn-arrow.svg')); ?>"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-8">
                        <div class="slider__content">
                            ...
                            <h2 class="title tg-svg" data-animation-in="slideInLeft" data-delay-in=".3" data-duration-in="0.8">Driving Digital <span class="position-relative"><span class="svg-icon" id="slider-2" data-svg-icon="<?php echo e(asset('images/theme/icons/title_shape.svg')); ?>"></span>Transformation</span> For Businesses</h2>
                            <ul class="list-wrap" data-animation-in="slideInLeft" data-delay-in=".4" data-duration-in="0.8">
                            ...
                            <div class="tg-button-wrap" data-animation-in="slideInLeft" data-delay-in=".5" data-duration-in="0.8">
                                <a href="#services" class="btn tg-svg"><span class="text">Our Services</span> <span class="svg-icon" id="slider-btn01-2" data-svg-icon="<?php echo e(asset('images/theme/icons/btn-arrow.svg')); ?>"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row courses-slider-active" id="servicesSlider" style="overflow-x: hidden; scroll-behavior: smooth;">
                ...
                <div class="courses__item-two shine__animate-item">
                    <div class="courses__item-two-thumb">
                        <a href="<?php echo e($course['url'] ?? '#'); ?>" class="shine__animate-link">
                            <img src="<?php echo e($course['image'] ?? asset('uploads/2019/05/courses01.jpg')); ?>" alt="<?php echo e($course['title'] ?? 'Course'); ?>" loading="lazy" />
                        </a>
                        <div class="author">
                            <a href="#">
                                <img alt='Author' src='<?php echo e(asset('uploads/2023/07/author_img.png')); ?>' class='avatar avatar-32 photo' height='32' width='32' loading="lazy" />
                            </a>
                        </div>
                    </div>
            ...
            <div class="col">
                <div class="courses__item-two shine__animate-item">
                    <div class="courses__item-two-thumb">
                        <a href="<?php echo e(route('service.show', 'ict-audits')); ?>" class="shine__animate-link">
                            <img src="<?php echo e(asset('uploads/2023/06/ict.jpg')); ?>" alt="ICT audits and IT lifecycle management" />
                        </a>
                    </div>
                    <div class="courses__item-two-content">
                        <div class="courses__item-categories"><a href="#">IT Audit</a></div>
                        <h5 class="title"><a href="<?php echo e(route('service.show', 'ict-audits')); ?>">ICT audits and IT lifecycle management</a></h5>
            ...
            <div class="col">
                <div class="courses__item-two shine__animate-item">
                    <div class="courses__item-two-thumb">
                        <a href="<?php echo e(route('service.show', 'outsourced-ict-support')); ?>" class="shine__animate-link">
                            <img src="<?php echo e(asset('uploads/2023/06/IT training.jpg')); ?>" alt="Outsourced ICT user support" />
                        </a>
                    </div>
                    <div class="courses__item-two-content">
                        <div class="courses__item-categories"><a href="#">Support</a></div>
                        <h5 class="title"><a href="<?php echo e(route('service.show', 'outsourced-ict-support')); ?>">Outsourced ICT user support</a></h5>
            ...
            <div class="col">
                <div class="courses__item-two shine__animate-item">
                    <div class="courses__item-two-thumb">
                        <a href="<?php echo e(route('service.show', 'network-infrastructure')); ?>" class="shine__animate-link">
                            <img src="<?php echo e(asset('images/internet1.jpg')); ?>" alt="Network Infrastructure" />
                        </a>
                    </div>
                    <div class="courses__item-two-content">
                        <div class="courses__item-categories"><a href="#">Infrastructure</a></div>
                        <h5 class="title"><a href="<?php echo e(route('service.show', 'network-infrastructure')); ?>">Network Infrastructure</a></h5>
            ...
            <div class="col">
                <div class="courses__item-two shine__animate-item">
                    <div class="courses__item-two-thumb">
                        <a href="<?php echo e(route('service.show', 'cloud-services')); ?>" class="shine__animate-link">
                            <img src="<?php echo e(asset('uploads/2023/06/software development.jpg')); ?>" alt="Cloud services" />
                        </a>
                    </div>
                    <div class="courses__item-two-content">
                        <div class="courses__item-categories"><a href="#">Cloud</a></div>
                        <h5 class="title"><a href="<?php echo e(route('service.show', 'cloud-services')); ?>">Cloud services for email, collaboration and file sharing</a></h5>
            ...
            <div class="col">
                <div class="courses__item-two shine__animate-item">
                    <div class="courses__item-two-thumb">
                        <a href="<?php echo e(route('service.show', 'datacenter-solutions')); ?>" class="shine__animate-link">
                            <img src="<?php echo e(asset('uploads/2023/06/IT training.jpg')); ?>" alt="Datacenter solutions" />
                        </a>
                    </div>
                    <div class="courses__item-two-content">
                        <div class="courses__item-categories"><a href="#">Datacenter</a></div>
                        <h5 class="title"><a href="<?php echo e(route('service.show', 'datacenter-solutions')); ?>">Datacenter solutions</a></h5>
            ...
            <div class="col">
                <div class="courses__item-two shine__animate-item">
                    <div class="courses__item-two-thumb">
                        <a href="<?php echo e(route('service.show', 'security-systems')); ?>" class="shine__animate-link">
                            <img src="<?php echo e(asset('uploads/2023/06/cyber.jpg')); ?>" alt="SECURITY SYSTEMS" />
                        </a>
                    </div>
                    <div class="courses__item-two-content">
                        <div class="courses__item-categories"><a href="#">Security</a></div>
                        <h5 class="title"><a href="<?php echo e(route('service.show', 'security-systems')); ?>">SECURITY SYSTEMS</a></h5>
            ...
            <div class="col">
                <div class="courses__item-two shine__animate-item">
                    <div class="courses__item-two-thumb">
                        <a href="<?php echo e(route('service.show', 'bulk-sms')); ?>" class="shine__animate-link">
                            <img src="<?php echo e(asset('images/sms.jpg')); ?>" alt="Bulk SMS and Integration to ERP" />
                        </a>
                    </div>
                    <div class="courses__item-two-content">
                        <div class="courses__item-categories"><a href="#">Messaging</a></div>
                        <h5 class="title"><a href="<?php echo e(route('service.show', 'bulk-sms')); ?>">Bulk SMS and Integration to ERP</a></h5>
            ...
            <div class="col">
                <div class="courses__item-two shine__animate-item">
                    <div class="courses__item-two-thumb">
                        <a href="<?php echo e(route('service.show', 'software-solutions')); ?>" class="shine__animate-link">
                            <img src="<?php echo e(asset('uploads/2023/06/software development.jpg')); ?>" alt="Software solutions" />
                        </a>
                    </div>
                    <div class="courses__item-two-content">
                        <div class="courses__item-categories"><a href="#">Software</a></div>
                        <h5 class="title"><a href="<?php echo e(route('service.show', 'software-solutions')); ?>">Software solutions</a></h5>
...
<section class="cta-area-two position-relative">
    ...
    <div class="cta__shapes">
        <img src="<?php echo e(asset('uploads/2023/07/cta_shape001.svg')); ?>" alt="img" class="position-absolute" data-aos="fade-down-right" data-aos-delay="300" loading="lazy">
        <img src="<?php echo e(asset('uploads/2023/07/cta_shape002.png')); ?>" alt="img" class="position-absolute" loading="lazy">
        <img src="<?php echo e(asset('uploads/2023/07/cta_shape003.svg')); ?>" alt="img" class="position-absolute" data-aos="fade-up-left" data-aos-delay="300" loading="lazy">
    </div>
</section>
<!-- cta-area-end -->
    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-lg-8 text-center">
                <div class="section__title">
                    ...
                    <h2 class="title tg-svg">Mission, Vision <span class="position-relative"><span class="svg-icon" id="svg-mvv" data-svg-icon="<?php echo e(asset('images/theme/icons/title_shape.svg')); ?>"></span>& Values</span></h2>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="features__item" style="background: #fff; padding: 30px; border-radius: 10px; height: 100%; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                    <div class="features__icon" style="margin-bottom: 20px;">
                        <img src="<?php echo e(asset('images/mission.png')); ?>" alt="Mission" style="width: 80px; height: 80px; object-fit: contain;" loading="lazy">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="features__item" style="background: #fff; padding: 30px; border-radius: 10px; height: 100%; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                    <div class="features__icon" style="margin-bottom: 20px;">
                        <img src="<?php echo e(asset('images/vision.png')); ?>" alt="Vision" style="width: 80px; height: 80px; object-fit: contain;" loading="lazy">
                    </div>
                    <div class="features__content">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="features__item" style="background: #fff; padding: 30px; border-radius: 10px; height: 100%; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                    <div class="features__icon" style="margin-bottom: 20px;">
                        <img src="<?php echo e(asset('images/values.png')); ?>" alt="Values" style="width: 80px; height: 80px; object-fit: contain;" loading="lazy">
                    </div>
                    <div class="features__content">
...
<section class="brand-area section-py-120">
    <div class="container">
        <div class="row brand-slider-active">
            ...
            <div class="col-12">
                <div class="brand__item">
                    <a href="#"><img src="<?php echo e(asset('uploads/2023/07/bidco logo.png')); ?>" alt="Brand" loading="lazy"></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="cta__wrapper" style="background: linear-gradient(135deg, #2467ec 0%, #1a4fb8 100%); position: relative; overflow: hidden;">
                    <div class="section__title white-title">
                        <h2 class="title tg-svg">Transform Your <span class="position-relative"><span class="svg-icon" id="svg-cta-title" data-svg-icon="<?php echo e(asset('images/theme/icons/title_shape.svg')); ?>"></span>Business</span> With Technology</h2>
                    </div>
                    <div class="cta__desc">
                    ...
                    <div class="tg-button-wrap justify-content-center justify-content-md-end">
                        <a href="#contact" class="btn white-btn tg-svg"><span class="text">Get Started</span> <span class="svg-icon" id="cta-btn-partner" data-svg-icon="<?php echo e(asset('images/theme/icons/btn-arrow.svg')); ?>"></span></a>
                    </div>
                    <img decoding="async" class="object" src="<?php echo e(asset('uploads/2023/07/cta_shape01-1.svg')); ?>" style="left: 25px; top: -35px;" alt="shape" data-aos="fade-down" data-aos-delay="400" loading="lazy">
                    <img decoding="async" class="object" src="<?php echo e(asset('uploads/2025/03/cta_shape02-new.svg')); ?>" style="right: -20px; bottom: -80px;" alt="shape" data-aos="fade-up" data-aos-delay="400" loading="lazy">
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ICT11\ICT1\ICT WEBSITE\eduvalt-laravel\resources\views/pages/home.blade.php ENDPATH**/ ?>