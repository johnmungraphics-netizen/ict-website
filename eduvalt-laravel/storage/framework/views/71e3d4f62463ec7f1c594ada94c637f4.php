...
<?php $__env->startSection('title', 'About Us - ICT Africa'); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6">
                <div class="about__title-wrap">
                    ...
                    <div class="tg-button-wrap">
                        <a href="<?php echo e(route('blog')); ?>" class="btn tg-svg"><span class="text">Our Services</span> <span class="svg-icon" id="about-btn" data-svg-icon="<?php echo e(asset('images/theme/icons/btn-arrow.svg')); ?>"></span></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-7 col-lg-6 col-md-11">
                <div class="about__images-wrap">
                    <div class="column">
                        <img decoding="async" src="<?php echo e(asset('uploads/2019/05/courses06.jpg')); ?>" alt="ICT Training">
                    </div>
                    <div class="column">
                        <img decoding="async" src="<?php echo e(asset('uploads/2019/05/courses03.jpg')); ?>" alt="Software Development">
                        <img decoding="async" src="<?php echo e(asset('uploads/2019/05/courses05.jpg')); ?>" alt="IT Infrastructure">
                    </div>
                    <div class="about__shapes">
                        <img decoding="async" src="<?php echo e(asset('uploads/2023/07/categories_shape02.png')); ?>" alt="img" class="about-shape-01" data-aos="fade-down-left">
                        <img decoding="async" src="<?php echo e(asset('uploads/2023/07/banner_shape02.png')); ?>" alt="img" class="about-shape-02" data-aos="fade-up-right">
                        <img decoding="async" src="<?php echo e(asset('uploads/2023/07/categories_shape01.png')); ?>" alt="img" class="about-shape-03 rotateme">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-8 text-center">
                <div class="section__title">
                    ...
                    <h2 class="title tg-svg">How We <span class="position-relative"><span class="svg-icon" id="svg-hww" data-svg-icon="<?php echo e(asset('images/theme/icons/title_shape.svg')); ?>"></span>Work</span></h2>
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-6 text-center">
                <div class="section__title">
                    ...
                    <h2 class="title tg-svg">Driving <span class="position-relative"><span class="svg-icon" id="svg-skills-about" data-svg-icon="<?php echo e(asset('images/theme/icons/title_shape.svg')); ?>"></span>Digital</span> Transformation Across Africa</h2>
                </div>
            </div>
        </div>
...
<section class="cta-area-two position-relative">
    <div class="cta__bg" style="background-image:url(<?php echo e(asset('uploads/2023/07/banner_bg.jpg')); ?>)"></div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-10">
                <div class="cta__content">
                    ...
                    <div class="tg-button-wrap justify-content-center">
                        <a href="<?php echo e(route('contact')); ?>" class="btn tg-svg"><span class="text">Get Started Today</span> <span class="svg-icon" id="cta-btn-about" data-svg-icon="<?php echo e(asset('images/theme/icons/btn-arrow.svg')); ?>"></span></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ICT11\ICT1\eduvalt-laravel\resources\views/pages/about.blade.php ENDPATH**/ ?>